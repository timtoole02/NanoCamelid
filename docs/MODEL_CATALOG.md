...
| Llama 3.2 3B Instruct | `Llama-3.2-3B-Instruct-Q4_0.gguf` | `llama` | Supported | `ready`; Llama 3 chat renderer; smoke chat generated `"Hello!"` with exact scalar-vs-selected logit parity; direct generation at about `2.22 tok/sec`; capped 8096-context smoke and TUI launch pass |
