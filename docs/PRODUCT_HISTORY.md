...
- The working model catalog lives in
  [MODEL_CATALOG.md](MODEL_CATALOG.md). It separates Pi-smoked
...
![NanoCamelid terminal chat showing model telemetry and token counters](images/nanocamelid-tui.png)
...
See [MODEL_CATALOG.md](MODEL_CATALOG.md) for likely-compatible
...
- [Pi porting notes](PI_PORTING.md)
- [Camelid porting map](CAMELID_PORTING_MAP.md)
